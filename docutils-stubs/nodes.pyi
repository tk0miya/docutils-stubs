...
from typing import Any, Callable, Dict, List, Optional, overload, Tuple, Type, TypeVar
...
class Node:
    ...
    @overload
    def traverse(self, condition: Callable[..., _N] = ..., include_self: bool = ..., descend: bool = ..., siblings: bool = ..., ascend: bool = ...) -> List[_N]: ...
    @overload
...
class Element(Node):
    ...
    def extend(self, item: List[nodes.Node]) -> None: ...
