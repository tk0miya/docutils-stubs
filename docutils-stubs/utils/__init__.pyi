...
from typing import Any, Dict, Callable, Generator, IO, List, Optional, Pattern, Tuple
...
class Reporter:
    ...
    max_level: int = ...
    def __init__(self, source: str, report_level: int, halt_level: int, stream: Optional[IO] = ..., debug: bool = ..., encoding: Optional[Any] = ..., error_handler: str = ...) -> None: ...
...
def assemble_option_dict(option_list: List[Tuple[str, str]], options_spec: Dict[str, Callable[[str], Any]]) -> Dict[str, Any]: ...
...
def get_source_line(node: nodes.Element) -> Tuple[str, int]: ...
