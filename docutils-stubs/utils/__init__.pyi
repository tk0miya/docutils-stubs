...
from typing import Any, Dict, Callable, Generator, IO, List, Mapping, Optional, Pattern, Tuple, Union
...
def assemble_option_dict(option_list: List[Tuple[str, str]], options_spec: Mapping[str, Callable[[str], Any]]) -> Dict[str, Any]: ...
