...
class RSTStateMachine(StateMachineWS):
    ...
    reporter: Reporter = ...
    node: nodes.Node = ...
    def run(self, input_lines: Union[List[str], StringList], document: nodes.document, input_offset: int = ..., match_titles: bool = ..., inliner: Optional["Inliner"] = ...) -> None: ...  # type: ignore
