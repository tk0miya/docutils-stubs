...
class Node:
    ...
    def traverse(self, condition: Optional[Any] = ..., include_self: bool = ..., descend: bool = ..., siblings: bool = ..., ascend: bool = ...) -> List[nodes.Node]: ...
...
class Element(Node):
    ...
    def __iadd__(self, other: Any) -> nodes.Element: ...  # type: ignore
    def astext(self) -> str: ...
