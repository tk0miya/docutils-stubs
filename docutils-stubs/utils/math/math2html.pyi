...
from typing import Any, AnyStr, Callable, ClassVar, Dict, Iterator, List, Mapping, MutableSequence, Optional, overload, Sequence, TextIO, Tuple, Type, TypeVar, Union
...
class FormulaParser(Parser):
    begin: int = ...
    def parseheader(self, reader: LineReader): ...
