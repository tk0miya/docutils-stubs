...
from typing import Any, Callable, List, Pattern, Type

__docformat__: str

def directive(directive_name: str, language_module: ModuleType, document: document): ...
def register_directive(name: str, directive: Type[Directive]): ...
...
def get_measure(argument: str, units: List[str]) -> float: ...
def length_or_unitless(argument: str) -> float: ...
def length_or_percentage_or_unitless(argument: str, default: str = ...) -> float: ...
...
def choice(argument: str, values: List[str]) -> str: ...
